...
View_PO::View_PO(Inputs* inputs, const std::string& name)
...
void View_PO::set_view_ratio(float64 px, float64 py, float64 pw, float64 ph)
{
	ratio_x_offset_ = px;
	ratio_y_offset_ = py;
	ratio_width_ = pw;
...
void View_PO::resize_event(int32 window_width, int32 window_height, int32 frame_buffer_width, int32 frame_buffer_height)
{
...
void View_PO::close_event()
{
	/*for (ViewModule_PO* m : linked_view_modules_)
		m->close_event();*/

	closing_ = true;
}

void View_PO::mouse_press_event(int32 button, int32 x, int32 y)
{
	/*for (ViewModule_PO* m : linked_view_modules_)
...
void View_PO::mouse_release_event(int32 button, int32 x, int32 y)
{
	/*for (ViewModule_PO* m : linked_view_modules_)
...
void View_PO::mouse_dbl_click_event(int32 button, int32 x, int32 y)
{
	/*for (ViewModule_PO* m : linked_view_modules_)
...
void View_PO::mouse_move_event(int32 x, int32 y)
{
	/*for (ViewModule_PO* m : linked_view_modules_)
...
void View_PO::mouse_wheel_event(float64 dx, float64 dy)
{
	/*for (ViewModule_PO* m : linked_view_modules_)
...
void View_PO::key_press_event(int32 key_code)
{
	/*for (ViewModule_PO* m : linked_view_modules_)
...
void View_PO::key_release_event(int32 key_code)
{
	/*for (ViewModule_PO* m : linked_view_modules_)
...
void View_PO::link_module(ViewModule_PO* m)
{
...
void View_PO::link_module(ProviderModule_PO* m)
{
...
void View_PO::update_scene_bb()
{
	...
	/*for (ProviderModule_PO* m : linked_provider_modules_)
	{
...
bool View_PO::pixel_scene_position(int32 x, int32 y, rendering::GLVec3d& P) const
{
	float z[4];
	GLint xs, ys;
	float64 xogl;
...
std::pair<rendering::GLVec3d, rendering::GLVec3d> View_PO::pixel_ray(int32 x, int32 y) const
{
...
rendering::GLVec3d View_PO::unproject(int32 x, int32 y, float64 z) const
{
