...
#ifndef CGOGN_UI_VIEW_PO_H_
#define CGOGN_UI_VIEW_PO_H_
...
class CGOGN_UI_EXPORT View_PO : public GLViewer
{
	friend class App_PO;

public:
	View_PO(Inputs* inputs, const std::string& name);
	virtual ~View_PO() override;
...
public:
	...
	void link_module(ViewModule_PO* m);
	void link_module(ProviderModule_PO* m);
...
protected:
	...
	std::vector<ViewModule_PO*> linked_view_modules_;
	std::vector<ProviderModule_PO*> linked_provider_modules_;
