...
#ifndef CGOGN_MODULE_SURFACE_DEFORMATION_PO_H_
#define CGOGN_MODULE_SURFACE_DEFORMATION_PO_H_
...
class SurfaceDeformationPO : public ViewModule
{
...
public:
	SurfaceDeformationPO(const App& app)
		: ViewModule(app, "SurfaceDeformationPO (" + std::string{mesh_traits<MESH>::name} + ")"), selected_mesh_(nullptr),
		  dragging_(false)
	{
	}
	~SurfaceDeformationPO()
	{
	}
...
protected:
	void init() override
	{
		...
		connections_.push_back(boost::synapse::connect<typename MeshProvider<MESH>::mesh_added>(
			mesh_provider_, this, &SurfaceDeformationPO<MESH>::init_mesh));
	}
...
#endif // CGOGN_MODULE_SURFACE_DEFORMATION_PO_H_
